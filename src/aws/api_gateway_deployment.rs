...
struct ApiGatewayDeploymentData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    stage_description: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ApiGatewayDeployment {
    ...
    #[doc= "Set the field `stage_description`.\n"]
    pub fn set_stage_description(self, v: impl Into<PrimField<String>>) -> Self {
        self.0.data.borrow_mut().stage_description = Some(v.into());
        self
    }
    ...
    #[doc= "Get a reference to the value of field `stage_description` after provisioning.\n"]
    pub fn stage_description(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.stage_description", self.extract_ref()))
    }
...
impl Dependable for ApiGatewayDeployment {
    fn extract_ref(&self) -> String {
    ...
    pub fn build(self, stack: &mut Stack) -> ApiGatewayDeployment {
        let out = ApiGatewayDeployment(Rc::new(ApiGatewayDeployment_ {
            ...
            data: RefCell::new(ApiGatewayDeploymentData {
                ...
                stage_description: core::default::Default::default(),
