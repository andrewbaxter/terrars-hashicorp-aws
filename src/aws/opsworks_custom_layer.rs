...
#[derive(Serialize)]
struct OpsworksCustomLayerData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    cloudwatch_configuration: Option<Vec<OpsworksCustomLayerCloudwatchConfigurationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ebs_volume: Option<Vec<OpsworksCustomLayerEbsVolumeEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    load_based_auto_scaling: Option<Vec<OpsworksCustomLayerLoadBasedAutoScalingEl>>,
    dynamic: OpsworksCustomLayerDynamic,
}

struct OpsworksCustomLayer_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<OpsworksCustomLayerData>,
}

#[derive(Clone)]
pub struct OpsworksCustomLayer(Rc<OpsworksCustomLayer_>);

impl OpsworksCustomLayer {
    ...
    pub fn set_cloudwatch_configuration(
        self,
        v: impl Into<BlockAssignable<OpsworksCustomLayerCloudwatchConfigurationEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn set_ebs_volume(self, v: impl Into<BlockAssignable<OpsworksCustomLayerEbsVolumeEl>>) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_load_based_auto_scaling(
        self,
        v: impl Into<BlockAssignable<OpsworksCustomLayerLoadBasedAutoScalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn cloudwatch_configuration(&self) -> ListRef<OpsworksCustomLayerCloudwatchConfigurationElRef> {
    ...
    pub fn load_based_auto_scaling(&self) -> ListRef<OpsworksCustomLayerLoadBasedAutoScalingElRef> {
        ListRef::new(self.shared().clone(), format!("{}.load_based_auto_scaling", self.extract_ref()))
    }
}

impl Resource for OpsworksCustomLayer {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Dependable for OpsworksCustomLayer {
    fn extract_ref(&self) -> String {
        Resource::extract_ref(self)
    }
}

impl ToListMappable for OpsworksCustomLayer {
    type O = ListRef<OpsworksCustomLayerRef>;
...
impl Resource_ for OpsworksCustomLayer_ {
    fn extract_resource_type(&self) -> String {
        "aws_opsworks_custom_layer".into()
    }
...
pub struct BuildOpsworksCustomLayer {
    pub tf_id: String,
    #[doc= ""]
...
impl BuildOpsworksCustomLayer {
    pub fn build(self, stack: &mut Stack) -> OpsworksCustomLayer {
        let out = OpsworksCustomLayer(Rc::new(OpsworksCustomLayer_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(OpsworksCustomLayerData {
...
pub struct OpsworksCustomLayerRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksCustomLayerRef {
...
#[derive(Serialize)]
pub struct OpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl {
...
impl ToListMappable for OpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl {
    type O = BlockAssignable<OpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl>;
...
pub struct BuildOpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl {
    #[doc= ""]
...
impl BuildOpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl {
    pub fn build(self) -> OpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl {
        OpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl {
...
pub struct OpsworksCustomLayerCloudwatchConfigurationElLogStreamsElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksCustomLayerCloudwatchConfigurationElLogStreamsElRef {
    fn new(shared: StackShared, base: String) -> OpsworksCustomLayerCloudwatchConfigurationElLogStreamsElRef {
        OpsworksCustomLayerCloudwatchConfigurationElLogStreamsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksCustomLayerCloudwatchConfigurationElLogStreamsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
struct OpsworksCustomLayerCloudwatchConfigurationElDynamic {
    log_streams: Option<DynamicBlock<OpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl>>,
}

#[derive(Serialize)]
pub struct OpsworksCustomLayerCloudwatchConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    enabled: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    log_streams: Option<Vec<OpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl>>,
    dynamic: OpsworksCustomLayerCloudwatchConfigurationElDynamic,
}

impl OpsworksCustomLayerCloudwatchConfigurationEl {
    ...
    pub fn set_log_streams(
        mut self,
        v: impl Into<BlockAssignable<OpsworksCustomLayerCloudwatchConfigurationElLogStreamsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for OpsworksCustomLayerCloudwatchConfigurationEl {
    type O = BlockAssignable<OpsworksCustomLayerCloudwatchConfigurationEl>;
...
pub struct BuildOpsworksCustomLayerCloudwatchConfigurationEl {}

impl BuildOpsworksCustomLayerCloudwatchConfigurationEl {
    pub fn build(self) -> OpsworksCustomLayerCloudwatchConfigurationEl {
        OpsworksCustomLayerCloudwatchConfigurationEl {
...
pub struct OpsworksCustomLayerCloudwatchConfigurationElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksCustomLayerCloudwatchConfigurationElRef {
    fn new(shared: StackShared, base: String) -> OpsworksCustomLayerCloudwatchConfigurationElRef {
        OpsworksCustomLayerCloudwatchConfigurationElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksCustomLayerCloudwatchConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn log_streams(&self) -> ListRef<OpsworksCustomLayerCloudwatchConfigurationElLogStreamsElRef> {
        ListRef::new(self.shared().clone(), format!("{}.log_streams", self.base))
    }
}

#[derive(Serialize)]
pub struct OpsworksCustomLayerEbsVolumeEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksCustomLayerEbsVolumeEl {
...
impl ToListMappable for OpsworksCustomLayerEbsVolumeEl {
    type O = BlockAssignable<OpsworksCustomLayerEbsVolumeEl>;
...
pub struct BuildOpsworksCustomLayerEbsVolumeEl {
    #[doc= ""]
...
impl BuildOpsworksCustomLayerEbsVolumeEl {
    pub fn build(self) -> OpsworksCustomLayerEbsVolumeEl {
        OpsworksCustomLayerEbsVolumeEl {
...
pub struct OpsworksCustomLayerEbsVolumeElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksCustomLayerEbsVolumeElRef {
    fn new(shared: StackShared, base: String) -> OpsworksCustomLayerEbsVolumeElRef {
        OpsworksCustomLayerEbsVolumeElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksCustomLayerEbsVolumeElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct OpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl {
...
impl ToListMappable for OpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl {
    type O = BlockAssignable<OpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl>;
...
pub struct BuildOpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl {}

impl BuildOpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl {
    pub fn build(self) -> OpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl {
        OpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl {
...
pub struct OpsworksCustomLayerLoadBasedAutoScalingElDownscalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksCustomLayerLoadBasedAutoScalingElDownscalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksCustomLayerLoadBasedAutoScalingElDownscalingElRef {
        OpsworksCustomLayerLoadBasedAutoScalingElDownscalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksCustomLayerLoadBasedAutoScalingElDownscalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct OpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    alarms: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    cpu_threshold: Option<PrimField<f64>>,
...
impl OpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl {
    #[doc= "Set the field `alarms`.\n"]
    pub fn set_alarms(mut self, v: impl Into<ListField<PrimField<String>>>) -> Self {
        self.alarms = Some(v.into());
        self
...
impl ToListMappable for OpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl {
    type O = BlockAssignable<OpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl>;
...
pub struct BuildOpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl {}

impl BuildOpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl {
    pub fn build(self) -> OpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl {
        OpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl {
            alarms: core::default::Default::default(),
            cpu_threshold: core::default::Default::default(),
            ignore_metrics_time: core::default::Default::default(),
            instance_count: core::default::Default::default(),
...
pub struct OpsworksCustomLayerLoadBasedAutoScalingElUpscalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksCustomLayerLoadBasedAutoScalingElUpscalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksCustomLayerLoadBasedAutoScalingElUpscalingElRef {
        OpsworksCustomLayerLoadBasedAutoScalingElUpscalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksCustomLayerLoadBasedAutoScalingElUpscalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize, Default)]
struct OpsworksCustomLayerLoadBasedAutoScalingElDynamic {
    downscaling: Option<DynamicBlock<OpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl>>,
    upscaling: Option<DynamicBlock<OpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl>>,
}

#[derive(Serialize)]
pub struct OpsworksCustomLayerLoadBasedAutoScalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    enable: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    downscaling: Option<Vec<OpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    upscaling: Option<Vec<OpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl>>,
    dynamic: OpsworksCustomLayerLoadBasedAutoScalingElDynamic,
}

impl OpsworksCustomLayerLoadBasedAutoScalingEl {
    ...
    pub fn set_downscaling(
        mut self,
        v: impl Into<BlockAssignable<OpsworksCustomLayerLoadBasedAutoScalingElDownscalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_upscaling(
        mut self,
        v: impl Into<BlockAssignable<OpsworksCustomLayerLoadBasedAutoScalingElUpscalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for OpsworksCustomLayerLoadBasedAutoScalingEl {
    type O = BlockAssignable<OpsworksCustomLayerLoadBasedAutoScalingEl>;
...
pub struct BuildOpsworksCustomLayerLoadBasedAutoScalingEl {}

impl BuildOpsworksCustomLayerLoadBasedAutoScalingEl {
    pub fn build(self) -> OpsworksCustomLayerLoadBasedAutoScalingEl {
        OpsworksCustomLayerLoadBasedAutoScalingEl {
...
pub struct OpsworksCustomLayerLoadBasedAutoScalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksCustomLayerLoadBasedAutoScalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksCustomLayerLoadBasedAutoScalingElRef {
        OpsworksCustomLayerLoadBasedAutoScalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksCustomLayerLoadBasedAutoScalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn downscaling(&self) -> ListRef<OpsworksCustomLayerLoadBasedAutoScalingElDownscalingElRef> {
    ...
    pub fn upscaling(&self) -> ListRef<OpsworksCustomLayerLoadBasedAutoScalingElUpscalingElRef> {
        ListRef::new(self.shared().clone(), format!("{}.upscaling", self.base))
    }
}

#[derive(Serialize, Default)]
struct OpsworksCustomLayerDynamic {
    cloudwatch_configuration: Option<DynamicBlock<OpsworksCustomLayerCloudwatchConfigurationEl>>,
    ebs_volume: Option<DynamicBlock<OpsworksCustomLayerEbsVolumeEl>>,
    load_based_auto_scaling: Option<DynamicBlock<OpsworksCustomLayerLoadBasedAutoScalingEl>>,
}
