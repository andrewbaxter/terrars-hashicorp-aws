...
#[derive(Serialize)]
struct OpsworksJavaAppLayerData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    app_server_version: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    jvm_options: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    jvm_type: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    jvm_version: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    cloudwatch_configuration: Option<Vec<OpsworksJavaAppLayerCloudwatchConfigurationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ebs_volume: Option<Vec<OpsworksJavaAppLayerEbsVolumeEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    load_based_auto_scaling: Option<Vec<OpsworksJavaAppLayerLoadBasedAutoScalingEl>>,
    dynamic: OpsworksJavaAppLayerDynamic,
}

struct OpsworksJavaAppLayer_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<OpsworksJavaAppLayerData>,
}

#[derive(Clone)]
pub struct OpsworksJavaAppLayer(Rc<OpsworksJavaAppLayer_>);

impl OpsworksJavaAppLayer {
    ...
    #[doc= "Set the field `app_server_version`.\n"]
    pub fn set_app_server_version(self, v: impl Into<PrimField<String>>) -> Self {
        self.0.data.borrow_mut().app_server_version = Some(v.into());
        self
    }
    ...
    #[doc= "Set the field `jvm_options`.\n"]
    pub fn set_jvm_options(self, v: impl Into<PrimField<String>>) -> Self {
        self.0.data.borrow_mut().jvm_options = Some(v.into());
        self
    }

    #[doc= "Set the field `jvm_type`.\n"]
    pub fn set_jvm_type(self, v: impl Into<PrimField<String>>) -> Self {
        self.0.data.borrow_mut().jvm_type = Some(v.into());
        self
    }

    #[doc= "Set the field `jvm_version`.\n"]
    pub fn set_jvm_version(self, v: impl Into<PrimField<String>>) -> Self {
        self.0.data.borrow_mut().jvm_version = Some(v.into());
        self
    }
    ...
    pub fn set_cloudwatch_configuration(
        self,
        v: impl Into<BlockAssignable<OpsworksJavaAppLayerCloudwatchConfigurationEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn set_ebs_volume(self, v: impl Into<BlockAssignable<OpsworksJavaAppLayerEbsVolumeEl>>) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_load_based_auto_scaling(
        self,
        v: impl Into<BlockAssignable<OpsworksJavaAppLayerLoadBasedAutoScalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    #[doc= "Get a reference to the value of field `app_server_version` after provisioning.\n"]
    pub fn app_server_version(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.app_server_version", self.extract_ref()))
    }
    ...
    #[doc= "Get a reference to the value of field `jvm_options` after provisioning.\n"]
    pub fn jvm_options(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.jvm_options", self.extract_ref()))
    }

    #[doc= "Get a reference to the value of field `jvm_type` after provisioning.\n"]
    pub fn jvm_type(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.jvm_type", self.extract_ref()))
    }

    #[doc= "Get a reference to the value of field `jvm_version` after provisioning.\n"]
    pub fn jvm_version(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.jvm_version", self.extract_ref()))
    }
    ...
    pub fn cloudwatch_configuration(&self) -> ListRef<OpsworksJavaAppLayerCloudwatchConfigurationElRef> {
    ...
    pub fn load_based_auto_scaling(&self) -> ListRef<OpsworksJavaAppLayerLoadBasedAutoScalingElRef> {
        ListRef::new(self.shared().clone(), format!("{}.load_based_auto_scaling", self.extract_ref()))
    }
}

impl Resource for OpsworksJavaAppLayer {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Dependable for OpsworksJavaAppLayer {
    fn extract_ref(&self) -> String {
        Resource::extract_ref(self)
    }
}

impl ToListMappable for OpsworksJavaAppLayer {
    type O = ListRef<OpsworksJavaAppLayerRef>;
...
impl Resource_ for OpsworksJavaAppLayer_ {
    fn extract_resource_type(&self) -> String {
        "aws_opsworks_java_app_layer".into()
    }
...
pub struct BuildOpsworksJavaAppLayer {
    pub tf_id: String,
    #[doc= ""]
    pub stack_id: PrimField<String>,
}

impl BuildOpsworksJavaAppLayer {
    pub fn build(self, stack: &mut Stack) -> OpsworksJavaAppLayer {
        let out = OpsworksJavaAppLayer(Rc::new(OpsworksJavaAppLayer_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(OpsworksJavaAppLayerData {
                depends_on: core::default::Default::default(),
                provider: None,
                lifecycle: core::default::Default::default(),
                for_each: None,
                app_server: core::default::Default::default(),
                app_server_version: core::default::Default::default(),
                ...
                jvm_options: core::default::Default::default(),
                jvm_type: core::default::Default::default(),
                jvm_version: core::default::Default::default(),
...
pub struct OpsworksJavaAppLayerRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksJavaAppLayerRef {
...
#[derive(Serialize)]
pub struct OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl {
...
impl ToListMappable for OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl {
    type O = BlockAssignable<OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl>;
...
pub struct BuildOpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl {
    #[doc= ""]
...
impl BuildOpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl {
    pub fn build(self) -> OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl {
        OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl {
...
pub struct OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsElRef {
    fn new(shared: StackShared, base: String) -> OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsElRef {
        OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
struct OpsworksJavaAppLayerCloudwatchConfigurationElDynamic {
    log_streams: Option<DynamicBlock<OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl>>,
}

#[derive(Serialize)]
pub struct OpsworksJavaAppLayerCloudwatchConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    enabled: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    log_streams: Option<Vec<OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl>>,
    dynamic: OpsworksJavaAppLayerCloudwatchConfigurationElDynamic,
}

impl OpsworksJavaAppLayerCloudwatchConfigurationEl {
    ...
    pub fn set_log_streams(
        mut self,
        v: impl Into<BlockAssignable<OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for OpsworksJavaAppLayerCloudwatchConfigurationEl {
    type O = BlockAssignable<OpsworksJavaAppLayerCloudwatchConfigurationEl>;
...
pub struct BuildOpsworksJavaAppLayerCloudwatchConfigurationEl {}

impl BuildOpsworksJavaAppLayerCloudwatchConfigurationEl {
    pub fn build(self) -> OpsworksJavaAppLayerCloudwatchConfigurationEl {
        OpsworksJavaAppLayerCloudwatchConfigurationEl {
...
pub struct OpsworksJavaAppLayerCloudwatchConfigurationElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksJavaAppLayerCloudwatchConfigurationElRef {
    fn new(shared: StackShared, base: String) -> OpsworksJavaAppLayerCloudwatchConfigurationElRef {
        OpsworksJavaAppLayerCloudwatchConfigurationElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksJavaAppLayerCloudwatchConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn log_streams(&self) -> ListRef<OpsworksJavaAppLayerCloudwatchConfigurationElLogStreamsElRef> {
        ListRef::new(self.shared().clone(), format!("{}.log_streams", self.base))
    }
}

#[derive(Serialize)]
pub struct OpsworksJavaAppLayerEbsVolumeEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksJavaAppLayerEbsVolumeEl {
...
impl ToListMappable for OpsworksJavaAppLayerEbsVolumeEl {
    type O = BlockAssignable<OpsworksJavaAppLayerEbsVolumeEl>;
...
pub struct BuildOpsworksJavaAppLayerEbsVolumeEl {
    #[doc= ""]
...
impl BuildOpsworksJavaAppLayerEbsVolumeEl {
    pub fn build(self) -> OpsworksJavaAppLayerEbsVolumeEl {
        OpsworksJavaAppLayerEbsVolumeEl {
...
pub struct OpsworksJavaAppLayerEbsVolumeElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksJavaAppLayerEbsVolumeElRef {
    fn new(shared: StackShared, base: String) -> OpsworksJavaAppLayerEbsVolumeElRef {
        OpsworksJavaAppLayerEbsVolumeElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksJavaAppLayerEbsVolumeElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl {
...
impl ToListMappable for OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl {
    type O = BlockAssignable<OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl>;
...
pub struct BuildOpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl {}

impl BuildOpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl {
    pub fn build(self) -> OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl {
        OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl {
...
pub struct OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingElRef {
        OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    alarms: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    cpu_threshold: Option<PrimField<f64>>,
...
impl OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl {
    #[doc= "Set the field `alarms`.\n"]
    pub fn set_alarms(mut self, v: impl Into<ListField<PrimField<String>>>) -> Self {
        self.alarms = Some(v.into());
        self
...
impl ToListMappable for OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl {
    type O = BlockAssignable<OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl>;
...
pub struct BuildOpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl {}

impl BuildOpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl {
    pub fn build(self) -> OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl {
        OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl {
            alarms: core::default::Default::default(),
            cpu_threshold: core::default::Default::default(),
            ignore_metrics_time: core::default::Default::default(),
            instance_count: core::default::Default::default(),
...
pub struct OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingElRef {
        OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize, Default)]
struct OpsworksJavaAppLayerLoadBasedAutoScalingElDynamic {
    downscaling: Option<DynamicBlock<OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl>>,
    upscaling: Option<DynamicBlock<OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl>>,
}

#[derive(Serialize)]
pub struct OpsworksJavaAppLayerLoadBasedAutoScalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    enable: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    downscaling: Option<Vec<OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    upscaling: Option<Vec<OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl>>,
    dynamic: OpsworksJavaAppLayerLoadBasedAutoScalingElDynamic,
}

impl OpsworksJavaAppLayerLoadBasedAutoScalingEl {
    ...
    pub fn set_downscaling(
        mut self,
        v: impl Into<BlockAssignable<OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_upscaling(
        mut self,
        v: impl Into<BlockAssignable<OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for OpsworksJavaAppLayerLoadBasedAutoScalingEl {
    type O = BlockAssignable<OpsworksJavaAppLayerLoadBasedAutoScalingEl>;
...
pub struct BuildOpsworksJavaAppLayerLoadBasedAutoScalingEl {}

impl BuildOpsworksJavaAppLayerLoadBasedAutoScalingEl {
    pub fn build(self) -> OpsworksJavaAppLayerLoadBasedAutoScalingEl {
        OpsworksJavaAppLayerLoadBasedAutoScalingEl {
...
pub struct OpsworksJavaAppLayerLoadBasedAutoScalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksJavaAppLayerLoadBasedAutoScalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksJavaAppLayerLoadBasedAutoScalingElRef {
        OpsworksJavaAppLayerLoadBasedAutoScalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksJavaAppLayerLoadBasedAutoScalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn downscaling(&self) -> ListRef<OpsworksJavaAppLayerLoadBasedAutoScalingElDownscalingElRef> {
    ...
    pub fn upscaling(&self) -> ListRef<OpsworksJavaAppLayerLoadBasedAutoScalingElUpscalingElRef> {
        ListRef::new(self.shared().clone(), format!("{}.upscaling", self.base))
    }
}

#[derive(Serialize, Default)]
struct OpsworksJavaAppLayerDynamic {
    cloudwatch_configuration: Option<DynamicBlock<OpsworksJavaAppLayerCloudwatchConfigurationEl>>,
    ebs_volume: Option<DynamicBlock<OpsworksJavaAppLayerEbsVolumeEl>>,
    load_based_auto_scaling: Option<DynamicBlock<OpsworksJavaAppLayerLoadBasedAutoScalingEl>>,
}
