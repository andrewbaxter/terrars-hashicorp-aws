...
#[derive(Serialize)]
struct OpsworksMemcachedLayerData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    allocated_memory: Option<PrimField<f64>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    cloudwatch_configuration: Option<Vec<OpsworksMemcachedLayerCloudwatchConfigurationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ebs_volume: Option<Vec<OpsworksMemcachedLayerEbsVolumeEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    load_based_auto_scaling: Option<Vec<OpsworksMemcachedLayerLoadBasedAutoScalingEl>>,
    dynamic: OpsworksMemcachedLayerDynamic,
}

struct OpsworksMemcachedLayer_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<OpsworksMemcachedLayerData>,
}

#[derive(Clone)]
pub struct OpsworksMemcachedLayer(Rc<OpsworksMemcachedLayer_>);

impl OpsworksMemcachedLayer {
    ...
    #[doc= "Set the field `allocated_memory`.\n"]
    pub fn set_allocated_memory(self, v: impl Into<PrimField<f64>>) -> Self {
        self.0.data.borrow_mut().allocated_memory = Some(v.into());
        self
    }
    ...
    pub fn set_cloudwatch_configuration(
        self,
        v: impl Into<BlockAssignable<OpsworksMemcachedLayerCloudwatchConfigurationEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn set_ebs_volume(self, v: impl Into<BlockAssignable<OpsworksMemcachedLayerEbsVolumeEl>>) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_load_based_auto_scaling(
        self,
        v: impl Into<BlockAssignable<OpsworksMemcachedLayerLoadBasedAutoScalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    #[doc= "Get a reference to the value of field `allocated_memory` after provisioning.\n"]
    pub fn allocated_memory(&self) -> PrimExpr<f64> {
        PrimExpr::new(self.shared().clone(), format!("{}.allocated_memory", self.extract_ref()))
    }
    ...
    pub fn cloudwatch_configuration(&self) -> ListRef<OpsworksMemcachedLayerCloudwatchConfigurationElRef> {
    ...
    pub fn load_based_auto_scaling(&self) -> ListRef<OpsworksMemcachedLayerLoadBasedAutoScalingElRef> {
...
impl Resource_ for OpsworksMemcachedLayer_ {
    fn extract_resource_type(&self) -> String {
        "aws_opsworks_memcached_layer".into()
    }
...
pub struct BuildOpsworksMemcachedLayer {
    pub tf_id: String,
    #[doc= ""]
    pub stack_id: PrimField<String>,
}

impl BuildOpsworksMemcachedLayer {
    pub fn build(self, stack: &mut Stack) -> OpsworksMemcachedLayer {
        let out = OpsworksMemcachedLayer(Rc::new(OpsworksMemcachedLayer_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(OpsworksMemcachedLayerData {
                depends_on: core::default::Default::default(),
                provider: None,
                lifecycle: core::default::Default::default(),
                for_each: None,
                allocated_memory: core::default::Default::default(),
...
pub struct OpsworksMemcachedLayerRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksMemcachedLayerRef {
...
impl OpsworksMemcachedLayerRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
...
#[derive(Serialize)]
pub struct OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl {
...
impl ToListMappable for OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl {
    type O = BlockAssignable<OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl>;
...
pub struct BuildOpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl {
    #[doc= ""]
...
impl BuildOpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl {
    pub fn build(self) -> OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl {
        OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl {
...
pub struct OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsElRef {
    fn new(shared: StackShared, base: String) -> OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsElRef {
        OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
struct OpsworksMemcachedLayerCloudwatchConfigurationElDynamic {
    log_streams: Option<DynamicBlock<OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl>>,
}

#[derive(Serialize)]
pub struct OpsworksMemcachedLayerCloudwatchConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    enabled: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    log_streams: Option<Vec<OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl>>,
    dynamic: OpsworksMemcachedLayerCloudwatchConfigurationElDynamic,
}

impl OpsworksMemcachedLayerCloudwatchConfigurationEl {
    ...
    pub fn set_log_streams(
        mut self,
        v: impl Into<BlockAssignable<OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for OpsworksMemcachedLayerCloudwatchConfigurationEl {
    type O = BlockAssignable<OpsworksMemcachedLayerCloudwatchConfigurationEl>;
...
pub struct BuildOpsworksMemcachedLayerCloudwatchConfigurationEl {}

impl BuildOpsworksMemcachedLayerCloudwatchConfigurationEl {
    pub fn build(self) -> OpsworksMemcachedLayerCloudwatchConfigurationEl {
        OpsworksMemcachedLayerCloudwatchConfigurationEl {
...
pub struct OpsworksMemcachedLayerCloudwatchConfigurationElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksMemcachedLayerCloudwatchConfigurationElRef {
    fn new(shared: StackShared, base: String) -> OpsworksMemcachedLayerCloudwatchConfigurationElRef {
        OpsworksMemcachedLayerCloudwatchConfigurationElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksMemcachedLayerCloudwatchConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn log_streams(&self) -> ListRef<OpsworksMemcachedLayerCloudwatchConfigurationElLogStreamsElRef> {
        ListRef::new(self.shared().clone(), format!("{}.log_streams", self.base))
    }
}

#[derive(Serialize)]
pub struct OpsworksMemcachedLayerEbsVolumeEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksMemcachedLayerEbsVolumeEl {
...
impl ToListMappable for OpsworksMemcachedLayerEbsVolumeEl {
    type O = BlockAssignable<OpsworksMemcachedLayerEbsVolumeEl>;
...
pub struct BuildOpsworksMemcachedLayerEbsVolumeEl {
    #[doc= ""]
...
impl BuildOpsworksMemcachedLayerEbsVolumeEl {
    pub fn build(self) -> OpsworksMemcachedLayerEbsVolumeEl {
        OpsworksMemcachedLayerEbsVolumeEl {
...
pub struct OpsworksMemcachedLayerEbsVolumeElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksMemcachedLayerEbsVolumeElRef {
    fn new(shared: StackShared, base: String) -> OpsworksMemcachedLayerEbsVolumeElRef {
        OpsworksMemcachedLayerEbsVolumeElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksMemcachedLayerEbsVolumeElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl {
...
impl ToListMappable for OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl {
    type O = BlockAssignable<OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl>;
...
pub struct BuildOpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl {}

impl BuildOpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl {
    pub fn build(self) -> OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl {
        OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl {
...
pub struct OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingElRef {
        OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    alarms: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    cpu_threshold: Option<PrimField<f64>>,
...
impl OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl {
    #[doc= "Set the field `alarms`.\n"]
    pub fn set_alarms(mut self, v: impl Into<ListField<PrimField<String>>>) -> Self {
        self.alarms = Some(v.into());
        self
...
impl ToListMappable for OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl {
    type O = BlockAssignable<OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl>;
...
pub struct BuildOpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl {}

impl BuildOpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl {
    pub fn build(self) -> OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl {
        OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl {
            alarms: core::default::Default::default(),
            cpu_threshold: core::default::Default::default(),
            ignore_metrics_time: core::default::Default::default(),
            instance_count: core::default::Default::default(),
...
pub struct OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingElRef {
        OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize, Default)]
struct OpsworksMemcachedLayerLoadBasedAutoScalingElDynamic {
    downscaling: Option<DynamicBlock<OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl>>,
    upscaling: Option<DynamicBlock<OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl>>,
}

#[derive(Serialize)]
pub struct OpsworksMemcachedLayerLoadBasedAutoScalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    enable: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    downscaling: Option<Vec<OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    upscaling: Option<Vec<OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl>>,
    dynamic: OpsworksMemcachedLayerLoadBasedAutoScalingElDynamic,
}

impl OpsworksMemcachedLayerLoadBasedAutoScalingEl {
    ...
    pub fn set_downscaling(
        mut self,
        v: impl Into<BlockAssignable<OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_upscaling(
        mut self,
        v: impl Into<BlockAssignable<OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for OpsworksMemcachedLayerLoadBasedAutoScalingEl {
    type O = BlockAssignable<OpsworksMemcachedLayerLoadBasedAutoScalingEl>;
...
pub struct BuildOpsworksMemcachedLayerLoadBasedAutoScalingEl {}

impl BuildOpsworksMemcachedLayerLoadBasedAutoScalingEl {
    pub fn build(self) -> OpsworksMemcachedLayerLoadBasedAutoScalingEl {
        OpsworksMemcachedLayerLoadBasedAutoScalingEl {
...
pub struct OpsworksMemcachedLayerLoadBasedAutoScalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksMemcachedLayerLoadBasedAutoScalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksMemcachedLayerLoadBasedAutoScalingElRef {
        OpsworksMemcachedLayerLoadBasedAutoScalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksMemcachedLayerLoadBasedAutoScalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn downscaling(&self) -> ListRef<OpsworksMemcachedLayerLoadBasedAutoScalingElDownscalingElRef> {
    ...
    pub fn upscaling(&self) -> ListRef<OpsworksMemcachedLayerLoadBasedAutoScalingElUpscalingElRef> {
        ListRef::new(self.shared().clone(), format!("{}.upscaling", self.base))
    }
}

#[derive(Serialize, Default)]
struct OpsworksMemcachedLayerDynamic {
    cloudwatch_configuration: Option<DynamicBlock<OpsworksMemcachedLayerCloudwatchConfigurationEl>>,
    ebs_volume: Option<DynamicBlock<OpsworksMemcachedLayerEbsVolumeEl>>,
    load_based_auto_scaling: Option<DynamicBlock<OpsworksMemcachedLayerLoadBasedAutoScalingEl>>,
}
