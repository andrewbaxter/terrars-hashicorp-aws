...
#[derive(Serialize)]
struct OpsworksNodejsAppLayerData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    nodejs_version: Option<PrimField<String>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    cloudwatch_configuration: Option<Vec<OpsworksNodejsAppLayerCloudwatchConfigurationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ebs_volume: Option<Vec<OpsworksNodejsAppLayerEbsVolumeEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    load_based_auto_scaling: Option<Vec<OpsworksNodejsAppLayerLoadBasedAutoScalingEl>>,
    dynamic: OpsworksNodejsAppLayerDynamic,
}

struct OpsworksNodejsAppLayer_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<OpsworksNodejsAppLayerData>,
}

#[derive(Clone)]
pub struct OpsworksNodejsAppLayer(Rc<OpsworksNodejsAppLayer_>);

impl OpsworksNodejsAppLayer {
    ...
    #[doc= "Set the field `nodejs_version`.\n"]
    pub fn set_nodejs_version(self, v: impl Into<PrimField<String>>) -> Self {
        self.0.data.borrow_mut().nodejs_version = Some(v.into());
        self
    }
    ...
    pub fn set_cloudwatch_configuration(
        self,
        v: impl Into<BlockAssignable<OpsworksNodejsAppLayerCloudwatchConfigurationEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn set_ebs_volume(self, v: impl Into<BlockAssignable<OpsworksNodejsAppLayerEbsVolumeEl>>) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_load_based_auto_scaling(
        self,
        v: impl Into<BlockAssignable<OpsworksNodejsAppLayerLoadBasedAutoScalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    #[doc= "Get a reference to the value of field `nodejs_version` after provisioning.\n"]
    pub fn nodejs_version(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.nodejs_version", self.extract_ref()))
    }
    ...
    pub fn cloudwatch_configuration(&self) -> ListRef<OpsworksNodejsAppLayerCloudwatchConfigurationElRef> {
    ...
    pub fn load_based_auto_scaling(&self) -> ListRef<OpsworksNodejsAppLayerLoadBasedAutoScalingElRef> {
        ListRef::new(self.shared().clone(), format!("{}.load_based_auto_scaling", self.extract_ref()))
    }
}

impl Resource for OpsworksNodejsAppLayer {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Dependable for OpsworksNodejsAppLayer {
    fn extract_ref(&self) -> String {
        Resource::extract_ref(self)
    }
}

impl ToListMappable for OpsworksNodejsAppLayer {
    type O = ListRef<OpsworksNodejsAppLayerRef>;
...
impl Resource_ for OpsworksNodejsAppLayer_ {
    fn extract_resource_type(&self) -> String {
        "aws_opsworks_nodejs_app_layer".into()
    }
...
pub struct BuildOpsworksNodejsAppLayer {
    pub tf_id: String,
    #[doc= ""]
    pub stack_id: PrimField<String>,
}

impl BuildOpsworksNodejsAppLayer {
    pub fn build(self, stack: &mut Stack) -> OpsworksNodejsAppLayer {
        let out = OpsworksNodejsAppLayer(Rc::new(OpsworksNodejsAppLayer_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(OpsworksNodejsAppLayerData {
                ...
                nodejs_version: core::default::Default::default(),
...
pub struct OpsworksNodejsAppLayerRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksNodejsAppLayerRef {
...
impl OpsworksNodejsAppLayerRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
...
#[derive(Serialize)]
pub struct OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl {
...
impl ToListMappable for OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl {
    type O = BlockAssignable<OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl>;
...
pub struct BuildOpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl {
    #[doc= ""]
...
impl BuildOpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl {
    pub fn build(self) -> OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl {
        OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl {
...
pub struct OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsElRef {
    fn new(shared: StackShared, base: String) -> OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsElRef {
        OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
struct OpsworksNodejsAppLayerCloudwatchConfigurationElDynamic {
    log_streams: Option<DynamicBlock<OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl>>,
}

#[derive(Serialize)]
pub struct OpsworksNodejsAppLayerCloudwatchConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    enabled: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    log_streams: Option<Vec<OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl>>,
    dynamic: OpsworksNodejsAppLayerCloudwatchConfigurationElDynamic,
}

impl OpsworksNodejsAppLayerCloudwatchConfigurationEl {
    ...
    pub fn set_log_streams(
        mut self,
        v: impl Into<BlockAssignable<OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for OpsworksNodejsAppLayerCloudwatchConfigurationEl {
    type O = BlockAssignable<OpsworksNodejsAppLayerCloudwatchConfigurationEl>;
...
pub struct BuildOpsworksNodejsAppLayerCloudwatchConfigurationEl {}

impl BuildOpsworksNodejsAppLayerCloudwatchConfigurationEl {
    pub fn build(self) -> OpsworksNodejsAppLayerCloudwatchConfigurationEl {
        OpsworksNodejsAppLayerCloudwatchConfigurationEl {
...
pub struct OpsworksNodejsAppLayerCloudwatchConfigurationElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksNodejsAppLayerCloudwatchConfigurationElRef {
    fn new(shared: StackShared, base: String) -> OpsworksNodejsAppLayerCloudwatchConfigurationElRef {
        OpsworksNodejsAppLayerCloudwatchConfigurationElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksNodejsAppLayerCloudwatchConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn log_streams(&self) -> ListRef<OpsworksNodejsAppLayerCloudwatchConfigurationElLogStreamsElRef> {
        ListRef::new(self.shared().clone(), format!("{}.log_streams", self.base))
    }
}

#[derive(Serialize)]
pub struct OpsworksNodejsAppLayerEbsVolumeEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksNodejsAppLayerEbsVolumeEl {
...
impl ToListMappable for OpsworksNodejsAppLayerEbsVolumeEl {
    type O = BlockAssignable<OpsworksNodejsAppLayerEbsVolumeEl>;
...
pub struct BuildOpsworksNodejsAppLayerEbsVolumeEl {
    #[doc= ""]
...
impl BuildOpsworksNodejsAppLayerEbsVolumeEl {
    pub fn build(self) -> OpsworksNodejsAppLayerEbsVolumeEl {
        OpsworksNodejsAppLayerEbsVolumeEl {
...
pub struct OpsworksNodejsAppLayerEbsVolumeElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksNodejsAppLayerEbsVolumeElRef {
    fn new(shared: StackShared, base: String) -> OpsworksNodejsAppLayerEbsVolumeElRef {
        OpsworksNodejsAppLayerEbsVolumeElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksNodejsAppLayerEbsVolumeElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl {
...
impl ToListMappable for OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl {
    type O = BlockAssignable<OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl>;
...
pub struct BuildOpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl {}

impl BuildOpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl {
    pub fn build(self) -> OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl {
        OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl {
...
pub struct OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingElRef {
        OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    alarms: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    cpu_threshold: Option<PrimField<f64>>,
...
impl OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl {
    #[doc= "Set the field `alarms`.\n"]
    pub fn set_alarms(mut self, v: impl Into<ListField<PrimField<String>>>) -> Self {
        self.alarms = Some(v.into());
        self
...
impl ToListMappable for OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl {
    type O = BlockAssignable<OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl>;
...
pub struct BuildOpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl {}

impl BuildOpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl {
    pub fn build(self) -> OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl {
        OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl {
            alarms: core::default::Default::default(),
            cpu_threshold: core::default::Default::default(),
            ignore_metrics_time: core::default::Default::default(),
            instance_count: core::default::Default::default(),
...
pub struct OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingElRef {
        OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize, Default)]
struct OpsworksNodejsAppLayerLoadBasedAutoScalingElDynamic {
    downscaling: Option<DynamicBlock<OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl>>,
    upscaling: Option<DynamicBlock<OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl>>,
}

#[derive(Serialize)]
pub struct OpsworksNodejsAppLayerLoadBasedAutoScalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    enable: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    downscaling: Option<Vec<OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    upscaling: Option<Vec<OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl>>,
    dynamic: OpsworksNodejsAppLayerLoadBasedAutoScalingElDynamic,
}

impl OpsworksNodejsAppLayerLoadBasedAutoScalingEl {
    ...
    pub fn set_downscaling(
        mut self,
        v: impl Into<BlockAssignable<OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_upscaling(
        mut self,
        v: impl Into<BlockAssignable<OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for OpsworksNodejsAppLayerLoadBasedAutoScalingEl {
    type O = BlockAssignable<OpsworksNodejsAppLayerLoadBasedAutoScalingEl>;
...
pub struct BuildOpsworksNodejsAppLayerLoadBasedAutoScalingEl {}

impl BuildOpsworksNodejsAppLayerLoadBasedAutoScalingEl {
    pub fn build(self) -> OpsworksNodejsAppLayerLoadBasedAutoScalingEl {
        OpsworksNodejsAppLayerLoadBasedAutoScalingEl {
...
pub struct OpsworksNodejsAppLayerLoadBasedAutoScalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksNodejsAppLayerLoadBasedAutoScalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksNodejsAppLayerLoadBasedAutoScalingElRef {
        OpsworksNodejsAppLayerLoadBasedAutoScalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksNodejsAppLayerLoadBasedAutoScalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn downscaling(&self) -> ListRef<OpsworksNodejsAppLayerLoadBasedAutoScalingElDownscalingElRef> {
    ...
    pub fn upscaling(&self) -> ListRef<OpsworksNodejsAppLayerLoadBasedAutoScalingElUpscalingElRef> {
        ListRef::new(self.shared().clone(), format!("{}.upscaling", self.base))
    }
}

#[derive(Serialize, Default)]
struct OpsworksNodejsAppLayerDynamic {
    cloudwatch_configuration: Option<DynamicBlock<OpsworksNodejsAppLayerCloudwatchConfigurationEl>>,
    ebs_volume: Option<DynamicBlock<OpsworksNodejsAppLayerEbsVolumeEl>>,
    load_based_auto_scaling: Option<DynamicBlock<OpsworksNodejsAppLayerLoadBasedAutoScalingEl>>,
}
