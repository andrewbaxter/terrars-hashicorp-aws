...
#[derive(Serialize)]
struct OpsworksStaticWebLayerData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    cloudwatch_configuration: Option<Vec<OpsworksStaticWebLayerCloudwatchConfigurationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ebs_volume: Option<Vec<OpsworksStaticWebLayerEbsVolumeEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    load_based_auto_scaling: Option<Vec<OpsworksStaticWebLayerLoadBasedAutoScalingEl>>,
    dynamic: OpsworksStaticWebLayerDynamic,
}

struct OpsworksStaticWebLayer_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<OpsworksStaticWebLayerData>,
}

#[derive(Clone)]
pub struct OpsworksStaticWebLayer(Rc<OpsworksStaticWebLayer_>);

impl OpsworksStaticWebLayer {
    ...
    pub fn set_cloudwatch_configuration(
        self,
        v: impl Into<BlockAssignable<OpsworksStaticWebLayerCloudwatchConfigurationEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn set_ebs_volume(self, v: impl Into<BlockAssignable<OpsworksStaticWebLayerEbsVolumeEl>>) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_load_based_auto_scaling(
        self,
        v: impl Into<BlockAssignable<OpsworksStaticWebLayerLoadBasedAutoScalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn cloudwatch_configuration(&self) -> ListRef<OpsworksStaticWebLayerCloudwatchConfigurationElRef> {
    ...
    pub fn load_based_auto_scaling(&self) -> ListRef<OpsworksStaticWebLayerLoadBasedAutoScalingElRef> {
        ListRef::new(self.shared().clone(), format!("{}.load_based_auto_scaling", self.extract_ref()))
    }
}

impl Resource for OpsworksStaticWebLayer {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Dependable for OpsworksStaticWebLayer {
    fn extract_ref(&self) -> String {
        Resource::extract_ref(self)
    }
}

impl ToListMappable for OpsworksStaticWebLayer {
    type O = ListRef<OpsworksStaticWebLayerRef>;
...
impl Resource_ for OpsworksStaticWebLayer_ {
    fn extract_resource_type(&self) -> String {
        "aws_opsworks_static_web_layer".into()
    }
...
pub struct BuildOpsworksStaticWebLayer {
    pub tf_id: String,
    #[doc= ""]
    pub stack_id: PrimField<String>,
}

impl BuildOpsworksStaticWebLayer {
    pub fn build(self, stack: &mut Stack) -> OpsworksStaticWebLayer {
        let out = OpsworksStaticWebLayer(Rc::new(OpsworksStaticWebLayer_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(OpsworksStaticWebLayerData {
...
pub struct OpsworksStaticWebLayerRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksStaticWebLayerRef {
...
impl OpsworksStaticWebLayerRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
...
#[derive(Serialize)]
pub struct OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl {
...
impl ToListMappable for OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl {
    type O = BlockAssignable<OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl>;
...
pub struct BuildOpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl {
    #[doc= ""]
...
impl BuildOpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl {
    pub fn build(self) -> OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl {
        OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl {
...
pub struct OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsElRef {
    fn new(shared: StackShared, base: String) -> OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsElRef {
        OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
struct OpsworksStaticWebLayerCloudwatchConfigurationElDynamic {
    log_streams: Option<DynamicBlock<OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl>>,
}

#[derive(Serialize)]
pub struct OpsworksStaticWebLayerCloudwatchConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    enabled: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    log_streams: Option<Vec<OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl>>,
    dynamic: OpsworksStaticWebLayerCloudwatchConfigurationElDynamic,
}

impl OpsworksStaticWebLayerCloudwatchConfigurationEl {
    ...
    pub fn set_log_streams(
        mut self,
        v: impl Into<BlockAssignable<OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for OpsworksStaticWebLayerCloudwatchConfigurationEl {
    type O = BlockAssignable<OpsworksStaticWebLayerCloudwatchConfigurationEl>;
...
pub struct BuildOpsworksStaticWebLayerCloudwatchConfigurationEl {}

impl BuildOpsworksStaticWebLayerCloudwatchConfigurationEl {
    pub fn build(self) -> OpsworksStaticWebLayerCloudwatchConfigurationEl {
        OpsworksStaticWebLayerCloudwatchConfigurationEl {
...
pub struct OpsworksStaticWebLayerCloudwatchConfigurationElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksStaticWebLayerCloudwatchConfigurationElRef {
    fn new(shared: StackShared, base: String) -> OpsworksStaticWebLayerCloudwatchConfigurationElRef {
        OpsworksStaticWebLayerCloudwatchConfigurationElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksStaticWebLayerCloudwatchConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn log_streams(&self) -> ListRef<OpsworksStaticWebLayerCloudwatchConfigurationElLogStreamsElRef> {
        ListRef::new(self.shared().clone(), format!("{}.log_streams", self.base))
    }
}

#[derive(Serialize)]
pub struct OpsworksStaticWebLayerEbsVolumeEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksStaticWebLayerEbsVolumeEl {
...
impl ToListMappable for OpsworksStaticWebLayerEbsVolumeEl {
    type O = BlockAssignable<OpsworksStaticWebLayerEbsVolumeEl>;
...
pub struct BuildOpsworksStaticWebLayerEbsVolumeEl {
    #[doc= ""]
...
impl BuildOpsworksStaticWebLayerEbsVolumeEl {
    pub fn build(self) -> OpsworksStaticWebLayerEbsVolumeEl {
        OpsworksStaticWebLayerEbsVolumeEl {
...
pub struct OpsworksStaticWebLayerEbsVolumeElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksStaticWebLayerEbsVolumeElRef {
    fn new(shared: StackShared, base: String) -> OpsworksStaticWebLayerEbsVolumeElRef {
        OpsworksStaticWebLayerEbsVolumeElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksStaticWebLayerEbsVolumeElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl {
...
impl ToListMappable for OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl {
    type O = BlockAssignable<OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl>;
...
pub struct BuildOpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl {}

impl BuildOpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl {
    pub fn build(self) -> OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl {
        OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl {
...
pub struct OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingElRef {
        OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    alarms: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    cpu_threshold: Option<PrimField<f64>>,
...
impl OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl {
    #[doc= "Set the field `alarms`.\n"]
    pub fn set_alarms(mut self, v: impl Into<ListField<PrimField<String>>>) -> Self {
        self.alarms = Some(v.into());
        self
...
impl ToListMappable for OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl {
    type O = BlockAssignable<OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl>;
...
pub struct BuildOpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl {}

impl BuildOpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl {
    pub fn build(self) -> OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl {
        OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl {
            alarms: core::default::Default::default(),
            cpu_threshold: core::default::Default::default(),
            ignore_metrics_time: core::default::Default::default(),
            instance_count: core::default::Default::default(),
...
pub struct OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingElRef {
        OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize, Default)]
struct OpsworksStaticWebLayerLoadBasedAutoScalingElDynamic {
    downscaling: Option<DynamicBlock<OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl>>,
    upscaling: Option<DynamicBlock<OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl>>,
}

#[derive(Serialize)]
pub struct OpsworksStaticWebLayerLoadBasedAutoScalingEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    enable: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    downscaling: Option<Vec<OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    upscaling: Option<Vec<OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl>>,
    dynamic: OpsworksStaticWebLayerLoadBasedAutoScalingElDynamic,
}

impl OpsworksStaticWebLayerLoadBasedAutoScalingEl {
    ...
    pub fn set_downscaling(
        mut self,
        v: impl Into<BlockAssignable<OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_upscaling(
        mut self,
        v: impl Into<BlockAssignable<OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for OpsworksStaticWebLayerLoadBasedAutoScalingEl {
    type O = BlockAssignable<OpsworksStaticWebLayerLoadBasedAutoScalingEl>;
...
pub struct BuildOpsworksStaticWebLayerLoadBasedAutoScalingEl {}

impl BuildOpsworksStaticWebLayerLoadBasedAutoScalingEl {
    pub fn build(self) -> OpsworksStaticWebLayerLoadBasedAutoScalingEl {
        OpsworksStaticWebLayerLoadBasedAutoScalingEl {
...
pub struct OpsworksStaticWebLayerLoadBasedAutoScalingElRef {
    shared: StackShared,
    base: String,
}

impl Ref for OpsworksStaticWebLayerLoadBasedAutoScalingElRef {
    fn new(shared: StackShared, base: String) -> OpsworksStaticWebLayerLoadBasedAutoScalingElRef {
        OpsworksStaticWebLayerLoadBasedAutoScalingElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl OpsworksStaticWebLayerLoadBasedAutoScalingElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn downscaling(&self) -> ListRef<OpsworksStaticWebLayerLoadBasedAutoScalingElDownscalingElRef> {
    ...
    pub fn upscaling(&self) -> ListRef<OpsworksStaticWebLayerLoadBasedAutoScalingElUpscalingElRef> {
        ListRef::new(self.shared().clone(), format!("{}.upscaling", self.base))
    }
}

#[derive(Serialize, Default)]
struct OpsworksStaticWebLayerDynamic {
    cloudwatch_configuration: Option<DynamicBlock<OpsworksStaticWebLayerCloudwatchConfigurationEl>>,
    ebs_volume: Option<DynamicBlock<OpsworksStaticWebLayerEbsVolumeEl>>,
    load_based_auto_scaling: Option<DynamicBlock<OpsworksStaticWebLayerLoadBasedAutoScalingEl>>,
}
